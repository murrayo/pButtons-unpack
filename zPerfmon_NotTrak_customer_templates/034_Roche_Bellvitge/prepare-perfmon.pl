...
my @fieldlist=("PDH-CSV",
	...
	"Disco fsico(1 E:)\\Promedio de segundos de disco/lectura",
	"Disco fsico(1 E:)\\Promedio de segundos de disco/escritura",
	"Disco fsico(1 E:)\\Transferencias de disco/s",
	"Disco fsico(2 F:)\\Promedio de segundos de disco/lectura",
	"Disco fsico(2 F:)\\Promedio de segundos de disco/escritura",
	"Disco fsico(2 F:)\\Transferencias de disco/s");
	$separator=",";
