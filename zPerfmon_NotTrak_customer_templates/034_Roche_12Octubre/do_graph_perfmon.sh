...
then
	...
	./gnu_graphSnap.sh $1 15 "R data Disk Transfers sec" 0 1 0
	./gnu_graphSnap.sh $1 16 "S jnl Avg Disk sec Read" 0 1 1
	./gnu_graphSnap.sh $1 17 "S jnl Avg Disk sec Write" 0 1 1
	./gnu_graphSnap.sh $1 18 "S jnl Disk Transfers sec" 0 1 0
