...
my @fieldlist=("PDH-CSV",
	...
	"Disco fsico(2 R:)\\Promedio de segundos de disco/lectura",
	"Disco fsico(2 R:)\\Promedio de segundos de disco/escritura",
	"Disco fsico(2 R:)\\Lecturas de disco/s",
	"Disco fsico(2 R:)\\Escrituras en disco/s",
	"Disco fsico(2 R:)\\Transferencias de disco/s",
	"Disco fsico(3 S:)\\Promedio de segundos de disco/lectura",
	"Disco fsico(3 S:)\\Promedio de segundos de disco/escritura",
	"Disco fsico(3 S:)\\Lecturas de disco/s",
	"Disco fsico(3 S:)\\Escrituras en disco/s",
	"Disco fsico(3 S:)\\Transferencias de disco/s");
	$separator=",";
