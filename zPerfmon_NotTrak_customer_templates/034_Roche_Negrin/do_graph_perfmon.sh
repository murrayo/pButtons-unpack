...
./gnu_graph.sh $1 15 "R data Disk Reads per sec" 0 1 0
./gnu_graph.sh $1 16 "R data Disk Writes per sec" 0 1 0
./gnu_graph.sh $1 17 "R data Disk Transfers sec" 0 1 0

./gnu_graph.sh $1 18 "S jnl Avg Disk sec Read" 0 1 1
./gnu_graph.sh $1 19 "S jnl Avg Disk sec Write" 0 1 1
./gnu_graph.sh $1 20 "S Jnl Disk Reads per sec" 0 1 0
./gnu_graph.sh $1 21 "S Jnl Disk Writes per sec" 0 1 0
./gnu_graph.sh $1 22 "S jnl Disk Transfers sec" 0 1 0
...
then
	...
	./gnu_graphSnap.sh $1 13 "R data Avg Disk sec Read" 0 1 1
	./gnu_graphSnap.sh $1 14 "R data Avg Disk sec Write" 0 1 1
	./gnu_graphSnap.sh $1 15 "R data Disk Reads per sec" 0 1 0
	./gnu_graphSnap.sh $1 16 "R data Disk Writes per sec" 0 1 0
	./gnu_graphSnap.sh $1 17 "R data Disk Transfers sec" 0 1 0

	./gnu_graphSnap.sh $1 18 "S jnl Avg Disk sec Read" 0 1 1
	./gnu_graphSnap.sh $1 19 "S jnl Avg Disk sec Write" 0 1 1
	./gnu_graphSnap.sh $1 20 "S Jnl Disk Reads per sec" 0 1 0
	./gnu_graphSnap.sh $1 21 "S Jnl Disk Writes per sec" 0 1 0
	./gnu_graphSnap.sh $1 22 "S jnl Disk Transfers sec" 0 1 0
