...
my @fieldlist=("PDH-CSV",
	...
	"Disco fsico(4 E:)\\Promedio de segundos de disco/lectura",
	"Disco fsico(4 E:)\\Promedio de segundos de disco/escritura",
	"Disco fsico(4 E:)\\Lecturas de disco/s",
	"Disco fsico(4 E:)\\Escrituras en disco/s",	
	"Disco fsico(4 E:)\\Transferencias de disco/s",
	"Disco fsico(3 F:)\\Promedio de segundos de disco/lectura",
	"Disco fsico(3 F:)\\Promedio de segundos de disco/escritura",
	"Disco fsico(3 F:)\\Transferencias de disco/s");
	$separator=",";
