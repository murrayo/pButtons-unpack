...
./gnu_graph.sh $1 15 "E data Disk Reads per sec" 0 1 0
./gnu_graph.sh $1 16 "E data Disk Writes per sec" 0 1 0
./gnu_graph.sh $1 17 "E data Disk Transfers sec" 0 1 0
./gnu_graph.sh $1 18 "F jnl Avg Disk sec Read" 0 1 1
./gnu_graph.sh $1 19 "F jnl Avg Disk sec Write" 0 1 1
./gnu_graph.sh $1 20 "F jnl Disk Transfers sec" 0 1 0
...
then
	...
	./gnu_graphSnap.sh $1 15 "E data Disk Reads per sec" 0 1 0
	./gnu_graphSnap.sh $1 16 "E data Disk Writes per sec" 0 1 0
	
	./gnu_graphSnap.sh $1 17 "E data Disk Transfers sec" 0 1 0
	./gnu_graphSnap.sh $1 18 "F jnl Avg Disk sec Read" 0 1 1
	./gnu_graphSnap.sh $1 19 "F jnl Avg Disk sec Write" 0 1 1
	./gnu_graphSnap.sh $1 20 "F jnl Disk Transfers sec" 0 1 0
