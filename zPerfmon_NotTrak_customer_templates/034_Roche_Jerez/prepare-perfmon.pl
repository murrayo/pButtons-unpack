...
my @fieldlist=("PDH-CSV",
	...
	"Disco fsico(3 R:)\\Promedio de segundos de disco/lectura",
	"Disco fsico(3 R:)\\Promedio de segundos de disco/escritura",
	"Disco fsico(3 R:)\\Transferencias de disco/s",
	"Disco fsico(2 S:)\\Promedio de segundos de disco/lectura",
	"Disco fsico(2 S:)\\Promedio de segundos de disco/escritura",
	"Disco fsico(2 S:)\\Transferencias de disco/s");
	$separator=",";
