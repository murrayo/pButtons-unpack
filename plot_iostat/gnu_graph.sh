...
#
set decimal locale
set terminal pngcairo size 800,600 font "Arial,8"
set size ratio 0.60
set output "$mo_name.$mo_col_name.png"

set title enhanced font "Arial,10"
set title "$mo_true\n$mo_text" tc lt 3
...
else 	plot "$mo_name" using $mo_time_column:$mo_column with lines lt rgb "#71C671" title sprintf("Peak=%'.3f",ymax) axes x1y1; 
