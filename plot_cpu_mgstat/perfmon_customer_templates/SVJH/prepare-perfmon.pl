...
if ($curfile=="perfmon") {
	...
	"PhysicalDisk(2 F:)\\Avg. Disk sec/Read",
	"PhysicalDisk(2 F:)\\Avg. Disk sec/Write",
	"PhysicalDisk(2 F:)\\Disk Transfers/sec",
	"PhysicalDisk(5 K:)\\Avg. Disk sec/Read",
	"PhysicalDisk(5 K:)\\Avg. Disk sec/Write",
	"PhysicalDisk(5 K:)\\Disk Transfers/sec",
	"PhysicalDisk(6 N:)\\Avg. Disk sec/Read",
	"PhysicalDisk(6 N:)\\Avg. Disk sec/Write",
	"PhysicalDisk(6 N:)\\Disk Transfers/sec");
	$separator=",";
